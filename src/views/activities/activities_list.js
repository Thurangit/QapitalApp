		...
		<Fragment>
			...
			<Tab.Container defaultActiveKey="first">
				...
				<Row className="smarthpone">
					...
					<h6 className="normaltext mb-2">Community</h6>
					<Col xs="3" className="mb-4" onClick={() => page("/Association")}>
					...
					<h6 className="normaltext mb-2">Business</h6>
					...
					<Col xs="3" className="mb-4">
						...
						<div className="text-center">
							<small className="subtext">My Business</small>
						</div>
					</Col>


					<h6 className="normaltext mb-2">Finance</h6>
					<Col xs="3" className="mb-4" onClick={() => page("/Epargne/List")}>
						<div className="d-flex align-items-center justify-content-center">
					...
					<h6 className="normaltext mb-2">Leisures</h6>
					<Col xs="3" className="mb-4">
						<div className="d-flex align-items-center justify-content-center">
							<Image className="theme-color-default-img  rounded-pill avatar-50" src={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7b3ArkB7Oocsco2nxglnEoCAupiepqWfpmQ&usqp=CAU"} alt="qapital" />
							<Image className="theme-color-purple-img rounded-pill avatar-50" src={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7b3ArkB7Oocsco2nxglnEoCAupiepqWfpmQ&usqp=CAU"} alt="qapital" />
					...
					<h6 className="normaltext mb-2">Network</h6>
					<Col xs="3" className="mb-4">
						<div className="d-flex align-items-center justify-content-center">
							<Image className="theme-color-default-img  rounded-pill avatar-50" src={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7b3ArkB7Oocsco2nxglnEoCAupiepqWfpmQ&usqp=CAU"} alt="qapital" />
							<Image className="theme-color-purple-img rounded-pill avatar-50" src={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7b3ArkB7Oocsco2nxglnEoCAupiepqWfpmQ&usqp=CAU"} alt="qapital" />
						...
						<div className="text-center">
							<small className="subtext">Télécom</small>
						</div>
					</Col>
