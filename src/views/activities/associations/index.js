...
const AssociationIndex = memo((props) => {
                        ...
                        <Card.Body>
                            <div className="d-flex align-items-center justify-content-center">
                                <div className="d-flex flex-column align-items-center justify-content-between ">
                                    ...
                                    <div className="mt-3 text-black-50">
                                        <p>Slate helps you see how many more days you need Lorem lorem Lorem Lorem late helps you see how many more days you need Lorem lorem Lorem Lorem late helps you see how many more days you need Lorem lorem Lorem Loremlate helps you see how many more days you need Lorem lorem Lorem Loremlate helps you see how many more days you need Lorem lorem Lorem Loremlate helps you see how many more days you need Lorem lorem Lorem Lorem </p>
                                    </div>
                                        ...
                                        <Link to="#" className="btn btn-sm rounded-pill px-2 py-2 ms-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="text-success" width="20" height="20" viewBox="0 0 20 20" fill="currentColor">
                                                <path fillRule="evenodd" d="M18 10c0 3.866-3.582 7-8 7a8.841 8.841 0 01-4.083-.98L2 17l1.338-3.123C2.493 12.767 2 11.434 2 10c0-3.866 3.582-7 8-7s8 3.134 8 7zM7 9H5v2h2V9zm8 0h-2v2h2V9zM9 9h2v2H9V9z" clipRule="evenodd" />
																		...
																		<Link to="/Create/Association"><Button variant="btn btn-primary" className="mt-4">Créer</Button></Link>
                                </div>
