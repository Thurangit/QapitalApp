...
const ListGiftReceive = memo((props) => {
    ...
    const [gift_received_user, setgift_received_user] = useState([]);
    useEffect(() => {
        fetchAllgift_received_user();
    }, []);

    const fetchAllgift_received_user = () => {
        http.get('gifts/receives/user/' + userid).then(res => {
            setgift_received_user(res.data);
        })
    }
        ...
        <Fragment>
            ...
            <Row className="smarthpone">
                ...
                <div className="d-flex justify-content-between align-items-center mt-3 mb-4">
                    <div>
                        <h6 className="normaltitle">Cadeaux reçus</h6>
                    </div>
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            <ul className="list-inline m-0 p-0">
                                {gift_received_user.map((item, idg) => (
                                    <li className="d-flex mb-4 align-items-center" key="idg" onClick={() => page("/Gift/Open/" + item.ref_transaction + "/" + item.idsender_transaction + "/" + userid)}>
...
export default ListGiftReceive
