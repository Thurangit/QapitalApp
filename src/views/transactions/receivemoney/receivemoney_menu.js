...
import scanqrlogo from "../../../assets/images/brands/logoscanqr.jpg";
...
const ReceiveMoneyOptions = memo((props) => {
        ...
        <Fragment>
            ...
            <Row className="smarthpone">
                ...
                <div className="d-flex justify-content-between align-items-center mt-3 mb-4">
                    <div>
                        <h6 className="normaltitle">Recevoir</h6>
                    </div>
                            ...
                            <ul className="list-inline m-0 p-0">
                                ...
                                <li className="d-flex mb-4 align-items-center" key="idx">
                                    ...
                                    <div className="ms-2 flex-grow-1" >
                                        <h6 className="normaltext">Simple</h6>
                                        <p className="mb-0 subtext">A un utilisateur Qapital</p>
                                    </div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                                    </svg>
                                </li>
                                <li className="d-flex mb-4 align-items-center" onClick={() => page("/QR/Scan")}>
                                    <Image className="theme-color-default-img  rounded-pill avatar-30" src={scanqrlogo} alt="qapital" />
                                    <Image className="theme-color-purple-img rounded-pill avatar-30" src={scanqrlogo} alt="qapital" />
                                    <Image className="theme-color-blue-img rounded-pill avatar-30" src={scanqrlogo} alt="qapital" />
                                    <Image className="theme-color-green-img rounded-pill avatar-30" src={scanqrlogo} alt="qapital" />
                                    <Image className="theme-color-yellow-img rounded-pill avatar-30" src={scanqrlogo} alt="qapital" />
                                    <Image className="theme-color-pink-img rounded-pill avatar-30" src={scanqrlogo} alt="qapital" />
                                    <div className="ms-2 flex-grow-1" >
                                        <h6 className="normaltext">QR Code</h6>
                                        <p className="mb-0 subtext">Scan code</p>
                                    </div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                                    </svg>
                                ...
                                <li className="d-flex mb-4 align-items-center">
                                    ...
                                    <div className="ms-2 flex-grow-1" >
                                        <h6 className="normaltext">Mobile Money</h6>
                                ...
                                <li className="d-flex mb-4 align-items-center" onClick={() => page("/Gift/Receive/List")}>
                                    <Image className="theme-color-default-img  rounded-pill avatar-30" src={logogift} alt="qapital" />
                                    <Image className="theme-color-purple-img rounded-pill avatar-30" src={logogift} alt="qapital" />
                                    <Image className="theme-color-blue-img rounded-pill avatar-30" src={logogift} alt="qapital" />
                                    <Image className="theme-color-green-img rounded-pill avatar-30" src={logogift} alt="qapital" />
                                    <Image className="theme-color-yellow-img rounded-pill avatar-30" src={logogift} alt="qapital" />
                                    <Image className="theme-color-pink-img rounded-pill avatar-30" src={logogift} alt="qapital" />
                                    <div className="ms-2 flex-grow-1" >
                                        <h6 className="normaltext">Cadeaux reçus</h6>
...
export default ReceiveMoneyOptions
