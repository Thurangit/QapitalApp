...
const SendMoneyOptions = memo((props) => {
        ...
        <Fragment>
            ...
            <Row className="smarthpone">
                ...
                <div className="d-flex justify-content-between align-items-center mt-3 mb-4">
                    <div>
                        <h6 className="normaltitle">Envoi</h6>
                    </div>
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            <ul className="list-inline m-0 p-0">
                                ...
                                <li className="d-flex mb-4 align-items-center" >
                                    <Image className="theme-color-default-img  rounded-pill avatar-30" src={qrlogo} alt="qapital" />
                                    <Image className="theme-color-purple-img rounded-pill avatar-30" src={qrlogo} alt="qapital" />
                                    <Image className="theme-color-blue-img rounded-pill avatar-30" src={qrlogo} alt="qapital" />
                                    <Image className="theme-color-green-img rounded-pill avatar-30" src={qrlogo} alt="qapital" />
                                    <Image className="theme-color-yellow-img rounded-pill avatar-30" src={qrlogo} alt="qapital" />
                                    <Image className="theme-color-pink-img rounded-pill avatar-30" src={qrlogo} alt="qapital" />
                                    <div className="ms-2 flex-grow-1" onClick={() => page("/QR/Amount/Send/Money")}>
                                        <h6 className="normaltext">QR Code</h6>
                                        <p className="mb-0 subtext">paiement universel</p>
                                    </div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                                    </svg>
                                ...
                                <li className="d-flex mb-4 align-items-center" >
                                    ...
                                    <div className="ms-2 flex-grow-1" onClick={() => page("/Send/Money/Operators")}>
                                ...
                                <li className="d-flex mb-4 align-items-center" >
                                    ...
                                    <div className="ms-2 flex-grow-1" onClick={() => page("/Gift/Send/Money")}>
                                        <h6 className="normaltext">Cadeau</h6>
...
export default SendMoneyOptions
