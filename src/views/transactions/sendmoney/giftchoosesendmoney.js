...
const GiftChooseSendMoney = memo((props) => {
    ...
    const confirmtransactions = () => {
        ...
        http.post("search/user", inputs)
            .then((res) => {
                setIsLoading(false);
                navigate("/Gift/Amount/Send/Money/" + res.data)
            })
            .catch((e) => {
                setIsLoading(false);
                    ...
                    <Col>
                        ...
                        <Card>
                            ...
                            <Card.Body>
                                ...
                                <h6 className="smalltitle mb-3">Par identifiant</h6>
                                <form>
                                    <FormGroup>
                                        <div className="mb-2">
                                            <Form.Control className="form-control-sm" name="id" type="text" placeholder="Téléphone, Email, Identifiant" aria-label=".form-control-sm example" onChange={handleChange} />
                                        </div>
                                    </FormGroup>
                                    <button className="btn btn-success normaltext" onClick={confirmtransactions} disabled={isLoading}>{isLoading ? <Spinner
                                        as="span"
                                        animation="grow"
                                        size="sm"
                                        role="status"
                                        aria-hidden="true"
                                    /> : "Confirmer"}</button>{" "}
                                    <button type="submit" className="btn btn-danger normaltext">Annuler</button>
                                </form>
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            <ul className="list-inline m-0 p-0">
                                <h6 className="smalltitle mb-3">Contacts</h6>
                                {contacts_user.map((item, idus) => (
                                    <li className="d-flex mb-4 align-items-center" onClick={() => page("/Gift/Amount/Send/Money/" + item.id_relation)}>
...
export default GiftChooseSendMoney
