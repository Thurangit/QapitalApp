...
const GiftAmountSendMoney = memo((props) => {
    ...
    const listchoise = () => {
        console.log(inputs)
        navigate("/Gift/List/Themes/Send/Money/" + idreceiver + "/" + inputs.montant)
    }
                            ...
                            <div>
                                <form>
                                    <Form.Group className="mb-2" controlId="formBasicPassword">
                                        ...
                                        <Form.Control type="number" name="montant" placeholder="1000000" onChange={handleChange} />
                                    ...
                                    <div className="mt-3">
                                        <Button variant="primary" onClick={listchoise}>
                                            Confirmer
                                        </Button>
                                    </div>
                                </form>
...
export default GiftAmountSendMoney
