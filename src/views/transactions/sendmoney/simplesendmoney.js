...
const SimpleSendMoney = memo((props) => {
                        ...
                        <Card.Body>
                            <ul className="list-inline m-0 p-0">
                                ...
                                {contacts_user.map((item, idus) => (
                                    <li className="d-flex mb-4 align-items-center" onClick={() => page("/Confirm/Send/Money/" + item.id_relation)}>
...
export default SimpleSendMoney
