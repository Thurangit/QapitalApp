...
const ConfirmSendMoneyOperators = memo((props) => {
        ...
        <Fragment>
            ...
            <Row className="smarthpone">
                    ...
                    <Card>
                        <Card.Header className="d-flex justify-content-between">
                            <div className="header-title d-flex align-items-center">
                                <h6 className="card-title text-center normaltitle">
                                    Envoi d'argent
                                </h6>
                            </div>
                            ...
                            <div>
                                <form>
                                    <Form.Group className="mb-2" controlId="formBasicPassword">
                                        ...
                                        <Form.Control type="number" name="montant" placeholder="1000000" />
                ...
                <div className="d-flex justify-content-center align-items-center mt-3 mb-4">
                    <div className="bd-example me-1" onClick={() => page("/Send/Money/Operators/OM")}>
                        <figure className="figure">
                            <Image src={OM} className="bd-placeholder-img figure-img img-fluid rounded" />
                            <figcaption className="figure-caption text-center">Orange Money</figcaption>
                        </figure>
                    </div>

                    <div className="bd-example ms-1" onClick={() => page("/Send/Money/Operators/MOMO")}>
                        <figure className="figure">
                            <Image src={MOMO} className="bd-placeholder-img figure-img img-fluid rounded" />
                            <figcaption className="figure-caption text-center">MTN Mobile Money</figcaption>
                        </figure>
                    </div>
                </div>
...
export default ConfirmSendMoneyOperators
