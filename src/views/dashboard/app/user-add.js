                        ...
                        <Form>
                           <Form.Group className="form-group">
                              <div className="profile-img-edit position-relative">
                                 <Image className="theme-color-default-img  profile-pic rounded avatar-100" src={avatars1} alt="qapital"/>
                                 <Image className="theme-color-purple-img profile-pic rounded avatar-100" src={avatars2} alt="qapital"/>
                                 <Image className="theme-color-blue-img profile-pic rounded avatar-100" src={avatars3} alt="qapital"/>
                                 <Image className="theme-color-green-img profile-pic rounded avatar-100" src={avatars5} alt="qapital"/>
                                 <Image className="theme-color-yellow-img profile-pic rounded avatar-100" src={avatars6} alt="qapital"/>
                                 <Image className="theme-color-pink-img profile-pic rounded avatar-100" src={avatars4} alt="qapital"/>
