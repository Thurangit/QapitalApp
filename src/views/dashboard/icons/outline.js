        ...
        <>
            <Row>
                <Col lg="12">
                    <Card className="mb-4">
                        <Card.Header>
                            <h4 className="card-title mb-0">Outlined</h4>
                        </Card.Header>
                        <Card.Body>
                            <div className="icon-grid">
                                <div className="icon-box">
                                    ...
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-bs-placement="top" data-toggle="copy" data-bs-toggle="tooltip" data-copy-target="#svg-container-1" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                ...
                                <div className="icon-box">
                                    <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary"  data-copy-target="#svg-container-2" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-2">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <path
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M4.044 14.2505C2.693 14.4525 1.75 14.9255 1.75 15.9005C1.75 16.5715 2.194 17.0075 2.912 17.2815"
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                <div className="icon-box">
                                    <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#svg-container-3" data-toggle="copy"  title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-3">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M7.24512 14.7815L10.2383 10.8914L13.6524 13.5733L16.5815 9.79297" stroke="currentColor" strokeWidth="1.5"
                                                strokeLinecap="round" strokeLinejoin="round" />
                                            <circle cx="19.9954" cy="4.20027" r="1.9222" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                ...
                                <div className="icon-box">
                                    <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-bs-toggle="tooltip" data-bs-placement="top" data-copy-target="#svg-container-4" data-toggle="copy" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-4">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="icon-box">
                                    <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary"  data-toggle="copy" data-copy-target="#svg-container-4" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-5">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M19 8.5L12 15.5L5 8.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>               
                                <div className="icon-box">
                                    <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-copy-target="#svg-container-6" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-6">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M12.2515 12.6998V3.74976" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path fillRule  ="evenodd" clipRule="evenodd" d="M7.25049 12.6997L12.2515 20.6367L17.2525 12.6997H7.25049Z"
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                <div className="icon-box">
                                    <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-copy-target="#svg-container-7" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-7">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M8.52832 10.5576L11.9993 14.0436L15.4703 10.5576" stroke="currentColor" strokeWidth="1.5"
                                                strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                <div className="icon-box">
                                    <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-copy-target="#svg-container-8" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-8">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="icon-box">
                                    <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-copy-target="#svg-container-9" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-9">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M12.2744 19.75V4.75" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M18.299 13.7002L12.275 19.7502L6.25 13.7002" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                <div className="icon-box">
                                    <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-copy-target="#svg-container-11" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-10">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="icon-box">
                                    <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-copy-target="#svg-container-12" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-12">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M13.4424 8.52905L9.95638 12.0001L13.4424 15.4711" stroke="currentColor" strokeWidth="1.5"
                                                strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                <div className="icon-box">
                                    <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-copy-target="#svg-container-13" data-toggle="copy" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-13">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M7.91394 12L16.0859 12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M11.6777 15.748L7.91373 12L11.6777 8.25195" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                <div className="icon-box">
                                    <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-14" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-14">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M4.25 12.2744L19.25 12.2744" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M10.2998 18.2988L4.2498 12.2748L10.2998 6.24976" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                <div className="icon-box">
                                    <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-15" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                ...
                                <div className="icon-box">
                                    <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-16" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-16">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M12.7 11.7488H3.75" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path fillRule  ="evenodd" clipRule="evenodd" d="M12.7002 16.7498L20.6372 11.7488L12.7002 6.74776V16.7498Z"
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-17" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-17">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M10.5576 15.4709L14.0436 11.9999L10.5576 8.52895" stroke="currentColor" strokeWidth="1.5"
                                                strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>                                    
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-18" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-18">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-19" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-19">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-20" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-20">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M5 15.5L12 8.5L19 15.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-21" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-21">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M11.7485 11.3002L11.7485 20.2502" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path fillRule  ="evenodd" clipRule="evenodd" d="M16.7495 11.3003L11.7485 3.36329L6.74751 11.3003L16.7495 11.3003Z"
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-22" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-22">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M15.4712 13.4424L12.0002 9.95638L8.52919 13.4424" stroke="currentColor" strokeWidth="1.5"
                                                strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-23" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-23">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M12 7.91394L12 16.0859" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M8.25205 11.6777L12 7.91373L15.748 11.6777" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-24" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-24">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M11.7261 4.25L11.7261 19.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M5.70149 10.2998L11.7255 4.2498L17.7505 10.2998" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-25" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-25">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-26" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                       
                                    <div id="svg-container-26">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                            ...
                                            <path
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M15.2965 11.102H15.2507" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M9.4659 11.102H9.42013" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-27" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-27">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M8.27148 9.02811H15.5898" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-28" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-28">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-29" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-29">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-30" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-30">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M21.3149 3.75L15.3149 9.75" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M15.3149 3.75L21.3149 9.75" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-31" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-31">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                            ...
                                            <path
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M4.49988 21.5002L19.4999 5.50021" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-32" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-32">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-33" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-33">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-34" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-34">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-35" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-36" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-36">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-37" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-37">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M15.9393 12.4131H15.9483" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M11.9306 12.4131H11.9396" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M7.92128 12.4131H7.93028" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-38" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-38">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-39" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-39">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-40" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-40">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M12.0024 13.4147V10.3147" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M11.995 16.5H12.005" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                <div className="icon-box">
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-41" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-41">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-42" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-42">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-43" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-43">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                d="M8.27051 14.9519L9.86319 9.8627L14.9524 8.27002L13.3598 13.3593L8.27051 14.9519Z" stroke="currentColor"
                                                strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <circle cx="11.611" cy="11.611" r="9.61098" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-44" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-44">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-45" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-45">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-46" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-46">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-47" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-47">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-48" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-48">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M10.33 16.5928H4.0293" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M13.1406 6.90042H19.4413" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-49" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-49">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-50" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-50">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M7.48145 14.4629H16.2164" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-51" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-51">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M8.84819 12.314V16.059" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M10.7591 14.1868H6.93799" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M15.3661 12.428H15.259" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M17.1795 16.0027H17.0725" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-52" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-52">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-53" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-53">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-54" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-54">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M15.1049 12.6987C14.8729 13.9887 13.8569 15.0067 12.5679 15.2407" stroke="currentColor" strokeWidth="1.5"
                                                strokeLinecap="round" strokeLinejoin="round" />
                                            <path
                                            ...
                                            <path
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M19.8868 4.24951L4.11279 20.0235" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-55" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-55">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-56" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-56">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-57" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-57">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-58" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-58">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-59" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-59">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-60" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-60">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-61" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-61">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M15.8125 12.0217H3.77148" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M12.8848 9.10571L15.8128 12.0217L12.8848 14.9377" stroke="currentColor" strokeWidth="1.5"
                                                strokeLinecap="round" strokeLinejoin="round" />
                                            <path
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-63" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-63">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M21.8096 12.0215H9.76855" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M18.8813 9.1062L21.8093 12.0212L18.8813 14.9372" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-64" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-65" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-65">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M15.9393 12.0129H15.9483" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M11.9301 12.0129H11.9391" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M7.92128 12.0129H7.93028" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-66" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-66">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-67" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-67">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-68" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-68">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M14.4751 2.75V5.659C14.4751 7.079 15.6241 8.23 17.0441 8.234H19.7981" stroke="currentColor" strokeWidth="1.5"
                                                strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M11.6421 15.9497V9.90869" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M9.29639 13.5942L11.6414 15.9492L13.9864 13.5942" stroke="currentColor" strokeWidth="1.5"
                                                strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-69" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-69">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M14.4736 2.75024V5.65924C14.4736 7.07924 15.6216 8.23024 17.0416 8.23424H19.7966" stroke="currentColor"
                                                strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M13.5759 14.6481L10.1099 11.1821" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M10.1108 14.6481L13.5768 11.1821" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-70" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-70">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M14.4731 2.75V5.659C14.4731 7.079 15.6221 8.23 17.0421 8.234H19.7961" stroke="currentColor" strokeWidth="1.5"
                                                strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M14.2926 13.7471H9.39258" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-71" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-71">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M14.4741 2.75V5.659C14.4741 7.079 15.6231 8.23 17.0431 8.234H19.7971" stroke="currentColor" strokeWidth="1.5"
                                                strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M14.2936 12.9141H9.39355" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M11.8442 15.3639V10.4639" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-72" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-72">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M14.4746 2.75V5.659C14.4746 7.079 15.6236 8.23 17.0436 8.234H19.7976" stroke="currentColor" strokeWidth="1.5"
                                                strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M11.6406 9.90869V15.9497" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M13.9864 12.2642L11.6414 9.90918L9.29639 12.2642" stroke="currentColor" strokeWidth="1.5"
                                                strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-73" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-73">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-74" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-74">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                d="M16.334 2.75H7.665C4.644 2.75 2.75 4.889 2.75 7.916V16.084C2.75 19.111 4.635 21.25 7.665 21.25H16.333C19.364 21.25 21.25 19.111 21.25 16.084V7.916C21.25 4.889 19.364 2.75 16.334 2.75Z"
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-75" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-75">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-76" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-76">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M12.0001 8.32739V15.6537" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M15.6668 11.9904H8.3335" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                d="M16.6857 2H7.31429C4.04762 2 2 4.31208 2 7.58516V16.4148C2 19.6879 4.0381 22 7.31429 22H16.6857C19.9619 22 22 19.6879 22 16.4148V7.58516C22 4.31208 19.9619 2 16.6857 2Z"
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-77" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-77">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-78" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-78">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M22.5 12.8057H1.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M20.6304 8.5951V7.0821C20.6304 5.0211 18.9594 3.3501 16.8974 3.3501H15.6924" stroke="currentColor"
                                                strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M3.37012 8.5951V7.0821C3.37012 5.0211 5.04112 3.3501 7.10312 3.3501H8.33912" stroke="currentColor"
                                                strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M20.6304 12.8047V16.8787C20.6304 18.9407 18.9594 20.6117 16.8974 20.6117H15.6924" stroke="currentColor"
                                                strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M3.37012 12.8047V16.8787C3.37012 18.9407 5.04112 20.6117 7.10312 20.6117H8.33912" stroke="currentColor"
                                                strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-79" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-79">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-80" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-80">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-81" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-81">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <circle cx="12.1747" cy="11.8891" r="2.63616" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-82" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-82">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-83" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-83">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M13.864 13.8249L10.106 10.0669" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M10.106 13.8249L13.864 10.0669" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-84" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-84">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-85" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-85">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-86" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-86">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-87" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-87">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                d="M16.3345 2.75024H7.66549C4.64449 2.75024 2.75049 4.88924 2.75049 7.91624V16.0842C2.75049 19.1112 4.63549 21.2502 7.66549 21.2502H16.3335C19.3645 21.2502 21.2505 19.1112 21.2505 16.0842V7.91624C21.2505 4.88924 19.3645 2.75024 16.3345 2.75024Z"
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M8.43994 12.0002L10.8139 14.3732L15.5599 9.6272" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-88" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-88">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-89" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-89">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-90" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-90">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-91" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-91">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M15.391 14.0178L12 11.9948V7.63379" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-92" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-92">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                            ...
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M12.1128 13.9526V16.1746" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-93" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-93">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-94" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-94">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-95" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-95">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M12.0004 22.0001V18.8391" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M20 10.8005C20 15.2394 16.418 18.8382 12 18.8382C7.58093 18.8382 4 15.2394 4 10.8005" stroke="currentColor"
                                                strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M14.0693 6.75579H16.0589" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M13.0703 10.0934H16.0604" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-96" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-96">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M11.9995 22.0001V18.8391" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M20 10.8005C20 15.2394 16.4188 18.8382 11.9995 18.8382C7.58117 18.8382 4 15.2394 4 10.8005"
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-97" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-97">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-98" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-98">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                            ...
                                            <path
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M4.00146 20L7.71431 16.2869L14.5336 9.46706L20.0003 4" stroke="currentColor" strokeWidth="1.5"
                                                strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-99" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-99">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M19.5845 5.90405C22.1345 9.57507 22.1429 14.4174 19.5845 18.0956" stroke="currentColor" strokeWidth="1.5"
                                                strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M17.0811 8.31445C18.3924 10.6051 18.3924 13.4026 17.0811 15.6861" stroke="currentColor" strokeWidth="1.5"
                                                strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-100" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-100">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M18.049 11.6429H17.7373" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path fillRule  ="evenodd" clipRule="evenodd"
                                                ...
                                                stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M7.03516 7.5382H12.4341" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-101" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-101">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-102" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-102">
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-103" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-103">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <circle id="Ellipse 159" cx="12" cy="12" r="5" stroke="#130F26"/>
                                            <circle id="Ellipse 160" cx="12" cy="12" r="3" fill="#130F26"/>
                                            <mask id="mask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="9" y="9" width="6" height="6">
                                            <circle id="Ellipse 163" cx="12" cy="12" r="3" fill="#130F26"/>
                                            </mask>
                                            <circle id="Ellipse 161" opacity="0.89" cx="13.5" cy="10.5" r="1.5" fill="white"/>
                                            </svg>
                                ...
                                <div className="overlay">
                                    <OverlayTrigger placement="top"  delay={{ show: 250, hide: 400 }} overlay={renderTooltip}>
                                        <Button variant="btn btn-sm btn-soft-primary" data-toggle="copy" data-copy-target="#svg-container-104" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">Copy</Button>
                                    </OverlayTrigger>
                                    </div>
                                    <div id="svg-container-104">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <path d="M4 3.00004C4 1.89547 4.89543 1.00004 6 1.00004H13.0801C13.664 1.00004 14.2187 1.25517 14.5986 1.69845L19.5185 7.43826C19.8292 7.80075 20 8.26243 20 8.73985V21C20 22.1046 19.1046 23 18 23H6C4.89543 23 4 22.1046 4 21V3.00004Z" stroke="#130F26" strokeWidth="2" mask="url(#path-1-outside-1)"/>
                                            <mask id="mask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="3" y="0" width="18" height="24">
                                                ...
                                                <path d="M4 3.00004C4 1.89547 4.89543 1.00004 6 1.00004H13.0801C13.664 1.00004 14.2187 1.25517 14.5986 1.69845L19.5185 7.43826C19.8292 7.80075 20 8.26243 20 8.73985V21C20 22.1046 19.1046 23 18 23H6C4.89543 23 4 22.1046 4 21V3.00004Z" fill="#130F26"/>
                                                <path d="M4 3.00004C4 1.89547 4.89543 1.00004 6 1.00004H13.0801C13.664 1.00004 14.2187 1.25517 14.5986 1.69845L19.5185 7.43826C19.8292 7.80075 20 8.26243 20 8.73985V21C20 22.1046 19.1046 23 18 23H6C4.89543 23 4 22.1046 4 21V3.00004Z" stroke="#130F26" strokeWidth="2" mask="url(#path-2-outside-2)"/>
                                            </mask>
                                            <path id="Rectangle 21" d="M14 6V0L21 8H16C14.8954 8 14 7.10457 14 6Z" stroke="#130F26"/>
                                            ...
                                            <path fillRule  ="evenodd" clipRule="evenodd" d="M7 14.5945L8.99429 12.1334C9.12172 11.9761 9.34898 11.9549 9.50189 12.0859C9.6548 12.217 9.67546 12.4507 9.54804 12.6079L7.93828 14.5945L9.54804 16.581C9.67546 16.7383 9.6548 16.972 9.50189 17.103C9.34898 17.2341 9.12172 17.2128 8.99429 17.0556L7 14.5945Z" stroke="#130F26" strokeWidth="2" strokeLinecap="round" mask="url(#path-4-inside-3)"/>
                                            <path id="Line 71 (Stroke)" fillRule    ="evenodd" clipRule="evenodd" d="M13.771 11.1638C13.9576 11.2542 14.0356 11.4769 13.9451 11.6611L10.9973 17.6664C10.9069 17.8506 10.6823 17.9267 10.4957 17.8363C10.3091 17.7458 10.2311 17.5232 10.3215 17.3389L13.2693 11.3336C13.3598 11.1494 13.5844 11.0733 13.771 11.1638Z" fill="#130F26"/>
                                            <mask id="path-6-inside-4" fill="white">
                                                <path fillRule  ="evenodd" clipRule="evenodd" d="M17 14.5945L15.0057 17.0556C14.8783 17.2128 14.651 17.2341 14.4981 17.1031C14.3452 16.972 14.3245 16.7383 14.452 16.581L16.0617 14.5945L14.452 12.6079C14.3245 12.4507 14.3452 12.217 14.4981 12.0859C14.651 11.9549 14.8783 11.9761 15.0057 12.1334L17 14.5945Z"/>
                                            </mask>
                                            <path fillRule  ="evenodd" clipRule="evenodd" d="M17 14.5945L15.0057 17.0556C14.8783 17.2128 14.651 17.2341 14.4981 17.1031C14.3452 16.972 14.3245 16.7383 14.452 16.581L16.0617 14.5945L14.452 12.6079C14.3245 12.4507 14.3452 12.217 14.4981 12.0859C14.651 11.9549 14.8783 11.9761 15.0057 12.1334L17 14.5945Z" stroke="#130F26" strokeWidth="2" strokeLinecap="round" mask="url(#path-6-inside-4)"/>
                                        </svg>
                                    </div>
                                </div>
                            </div>
