               ...
               <Card>
                  <Card.Body>
                     <div className="border-bottom text-center pb-3">
                        <Image className="theme-color-default-img  img-fluid avatar-80 mb-4" src={avatars11} alt="qapital"/>
                        <Image className="theme-color-purple-img img-fluid avatar-80 mb-4" src={avatars22} alt="qapital"/>
                        <Image className="theme-color-blue-img img-fluid avatar-80 mb-4" src={avatars33} alt="qapital"/>
                        <Image className="theme-color-green-img img-fluid avatar-80 mb-4" src={avatars55} alt="qapital"/>
                        <Image className="theme-color-yellow-img img-fluid avatar-80 mb-4" src={avatars66} alt="qapital"/>
                        <Image className="theme-color-pink-img img-fluid avatar-80 mb-4" src={avatars44} alt="qapital"/>
                        <div>
