                            ...
                            <div className="d-flex align-items-center justify-content-center">
                                <div className="d-flex flex-column text-center align-items-center justify-content-between ">
                                    ...
                                    <div className="card-profile-progress">
                                        ...
                                        <Image className="theme-color-default-img  img-fluid rounded-circle card-img" src={avatars11} alt="qapital"/>
                                        <Image className="theme-color-purple-img img-fluid rounded-circle card-img" src={avatars22} alt="qapital"/>
                                        <Image className="theme-color-blue-img img-fluid rounded-circle card-img" src={avatars33} alt="qapital"/>
                                        <Image className="theme-color-green-img img-fluid rounded-circle card-img" src={avatars55} alt="qapital"/>
                                        <Image className="theme-color-yellow-img img-fluid rounded-circle card-img" src={avatars66} alt="qapital"/>
                        ...
                        <Card.Body>
                            <div className="twit-feed">
                                <div className="d-flex align-items-center mb-4">
                                    <Image className="theme-color-default-img rounded-pill img-fluid avatar-60 me-3" src={avatars11} alt="qapital"/>
                                    <Image className="theme-color-purple-img rounded-pill img-fluid avatar-60 me-3" src={avatars22} alt="qapital"/>
                                    <Image className="theme-color-blue-img rounded-pill img-fluid avatar-60 me-3" src={avatars33} alt="qapital"/>
                                    <Image className="theme-color-green-img rounded-pill img-fluid avatar-60 me-3" src={avatars55} alt="qapital"/>
                                    <Image className="theme-color-yellow-img rounded-pill img-fluid avatar-60 me-3" src={avatars66} alt="qapital"/>
                                    <Image className="theme-color-pink-img rounded-pill img-fluid avatar-60 me-3" src={avatars44} alt="qapital"/>
