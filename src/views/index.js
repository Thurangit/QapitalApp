                ...
                <Navbar.Collapse id="basic-navbar-nav" in={open3}>
                  <ul className="mb-2 navbar-nav ms-auto mb-lg-0 d-flex align-items-start">
                    <Nav.Item as="li">
                      <Nav.Link
                        aria-current="page"
                        href="https://templates.Qapital/hope-ui/documentation/react/build/"
                        target="_blank"
                      >
                        Documentation
                      </Nav.Link>
                    ...
                    <li className="nav-item me-3">
                      <Nav.Link
                        aria-current="page"
                        href="https://templates.Qapital/hope-ui/documentation/react/build/changelog"
                        target="_blank"
                      >
                        Change Log
                      </Nav.Link>
                    ...
                    <Nav.Item as="li" className="nav-item">
                        <Link className="btn btn-success" aria-current="page" to="https://Qapital/product/admin-templates/hope-ui-free-open-source-react-admin-template/" target="_blank" rel="noreferrer">
